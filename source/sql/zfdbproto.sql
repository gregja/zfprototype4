...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 05 juin 2022 à 22:34
...
CREATE TABLE `dossier` (
  `id` int(10) NOT NULL,
  `societe_id` int(10) NOT NULL DEFAULT 0,
  `dossier_ref` char(8) NOT NULL DEFAULT '',
  `personne_id` int(10) NOT NULL DEFAULT 0,
  `cde_ape` char(4) NOT NULL DEFAULT '',
  `cde_eta_jur` char(3) NOT NULL DEFAULT '',
  `cde_fam_prd` char(3) NOT NULL DEFAULT '',
  `statut` char(3) NOT NULL DEFAULT '',
  `typ_mat_id` char(8) NOT NULL DEFAULT '',
  `fam_ctx_id` char(3) NOT NULL DEFAULT '',
  `chgt_doss` date DEFAULT NULL,
  `cd_etat_cpt` char(1) NOT NULL DEFAULT '',
  `encours_mnt` decimal(15,2) NOT NULL DEFAULT 0.00,
  `solde_brut` decimal(15,2) NOT NULL DEFAULT 0.00,
  `top_cloture` char(1) NOT NULL DEFAULT ''
...
INSERT INTO `dossier` (`id`, `societe_id`, `dossier_ref`, `personne_id`, `cde_ape`, `cde_eta_jur`, `cde_fam_prd`, `statut`, `typ_mat_id`, `fam_ctx_id`, `chgt_doss`, `cd_etat_cpt`, `encours_mnt`, `solde_brut`, `top_cloture`) VALUES
(1, 1, '060DA610', 40, '001', 'CTX', '', 'ENC', '', '006', '2011-03-22', 'D', '5922.48', '281.33', ''),
(2, 1, '380FT610', 21, '', 'CTX', '', 'ENC', '34102501', '002', '1999-06-01', 'D', '11326.61', '957.07', ''),
...
(5, 3, 'H0106543', 115, '', 'CTX', '', 'ENC', '', '002', '2001-07-25', 'D', '10790.73', '968.27', ''),
(6, 1, '370CT425', 354, '', 'CTX', '', 'ENC', '341021', '001', '2000-12-28', 'D', '10972.75', '509.92', ''),
(7, 1, '430JT108', 427, '', 'CTX', '', 'ENC', '34102503', '002', '1999-06-01', 'D', '4068.77', '929.07', ''),
(8, 3, 'I0007297', 70, '', 'CTX', '', 'ENC', '35411201', '003', '2002-10-29', 'D', '1450.66', '83.08', ''),
(9, 3, 'I0003479', 71, '', 'CTX', '', 'ENC', '354112', '003', '2003-01-21', 'D', '7591.04', '136.93', ''),
(10, 3, 'H0110324', 144, '', 'CTX', '', 'ENC', '34102503', '002', '2001-09-27', 'D', '6524.53', '813.89', ''),
(11, 3, 'H0103458', 5, '', 'CTX', '', 'ENC', '34102502', '002', '2002-05-15', 'D', '11886.63', '256.50', ''),
...
(15, 1, '250DT690', 462, '', 'CTX', '', 'ENC', '', '007', '1999-06-01', 'D', '5479.08', '738.71', ''),
(16, 1, '860CO019', 427, '', 'LJ', '', 'ENC', '331015', '010', '1999-06-01', 'D', '234155.53', '257.49', ''),
(17, 1, '130BO079', 247, '', 'LJ', '', 'ENC', '295230', '010', '2001-10-10', 'D', '29866.06', '188.84', ''),
(18, 3, '116CO058', 453, '', 'LJ', '', 'ENC', '341043', '008', '2002-03-13', 'D', '6044.20', '230.48', ''),
(19, 1, '880IO278', 25, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '40414.82', '644.65', ''),
(20, 1, '480MC044', 266, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '34166.38', '178.95', ''),
(21, 1, '360LS031', 252, '', 'LJ', '', 'ENC', '299999', '010', '1999-06-01', 'D', '33916.23', '538.28', ''),
(22, 1, '360LS019', 464, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '14334.50', '611.68', ''),
(23, 1, '360BO103', 63, '', 'CTX', '', 'ENC', '293122', '009', '2001-10-11', 'D', '56687.08', '762.39', ''),
(24, 1, '060BO037', 423, '', 'LJ', '', 'ENC', '341044', '008', '2000-03-31', 'D', '23666.88', '975.23', ''),
(25, 1, '060AO005', 426, '', 'LJ', '', 'ENC', '341043', '008', '1999-12-09', 'D', '9038.13', '677.93', ''),
(26, 1, '730HO048', 361, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '25674.68', '78.60', ''),
(27, 1, '730CO015', 27, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '33672.55', '321.95', ''),
(28, 1, '440LI011', 51, '', 'LJ', '', 'ENC', '341044', '008', '1999-06-01', 'D', '9512.90', '389.67', ''),
(29, 1, '280OG051', 174, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '2840.84', '481.18', ''),
(30, 1, '280HO018', 214, '', 'CTX', '', 'ENC', '295230', '010', '1999-06-01', 'D', '25564.39', '615.42', ''),
(31, 1, '125AO004', 50, '', 'LJ', '', 'ENC', '294011', '010', '2000-02-21', 'D', '9556.33', '352.37', ''),
(32, 1, '050FO352', 108, '', 'CTX', '', 'ENC', '295316', '010', '1999-06-01', 'D', '15073.67', '116.25', ''),
(33, 1, '050FO240', 387, '', 'RJ', '', 'ENC', '293121', '009', '1999-06-01', 'D', '6468.43', '982.41', ''),
(34, 1, '050EO212', 113, '', 'RJ', '', 'ENC', '293121', '009', '1999-06-01', 'D', '8007.74', '659.47', ''),
...
(37, 1, '640KO033', 121, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '52686.11', '635.27', ''),
(38, 1, '460BO024', 111, '', 'LJ', '', 'ENC', '294011', '010', '2002-01-28', 'D', '9088.41', '46.23', ''),
(39, 1, '450MO082', 193, '', 'RJ', '', 'ENC', '341044', '008', '1999-06-01', 'D', '45244.75', '91.06', ''),
(40, 1, '430AO028', 129, '', 'RJ', '', 'ENC', '341044', '008', '2001-01-15', 'D', '6549.23', '273.96', ''),
(41, 1, '250NV079', 67, '', 'CTX', '', 'ENC', '294011', '010', '1999-06-01', 'D', '31504.92', '360.73', ''),
(42, 1, '070OX196', 447, '', 'CTX', '', 'ENC', '293122', '009', '1999-06-01', 'D', '27958.90', '363.30', ''),
(43, 1, '070MZ135', 32, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '20479.59', '626.06', ''),
(44, 1, '040JO063', 321, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '22700.93', '620.47', ''),
(45, 1, '040DO183', 9, '', 'RJ', '', 'ENC', '341044', '008', '1999-06-01', 'D', '3526.96', '139.40', ''),
(46, 1, '770CO142', 81, '', 'CTX', '', 'ENC', '294011', '010', '1999-06-01', 'D', '19851.13', '999.43', ''),
(47, 1, '330IO112', 378, '', 'LJ', '', 'ENC', '292217', '010', '1999-06-01', 'D', '18461.15', '774.48', ''),
(48, 1, '330AO117', 145, '', 'RJ', '', 'ENC', '341044', '008', '2000-12-01', 'D', '44564.15', '700.30', ''),
(49, 1, '190MZ062', 93, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '7524.25', '320.35', ''),
(50, 1, '190BO053', 29, '', 'LJ', '', 'ENC', '295230', '010', '2000-07-07', 'D', '45237.42', '734.02', ''),
(51, 1, 'I0004234', 364, '', 'RJ', '', 'ENC', '29221301', '010', '2000-11-13', 'D', '15375.64', '73.13', ''),
(52, 1, '670HO034', 234, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '46216.16', '708.38', ''),
(53, 1, '670DO073', 75, '', 'CTX', '', 'ENC', '294011', '010', '1999-06-01', 'D', '9489.62', '815.99', ''),
(54, 1, '610FO005', 175, '', 'LJ', '', 'ENC', '292217', '010', '1999-06-01', 'D', '73812.67', '128.37', ''),
(55, 1, '350LI005', 149, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '7352.45', '25.13', ''),
(56, 1, '350LI004', 219, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '8082.30', '272.11', ''),
(57, 1, '130JO097', 148, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '19617.45', '918.93', ''),
(58, 1, '130FO022', 83, '', 'RJ', '', 'ENC', '295316', '010', '1999-06-01', 'D', '40597.68', '40.62', ''),
(59, 1, '130AO018', 470, '', 'PRE', '', 'ENC', '341044', '008', '2001-08-30', 'D', '6414.08', '416.53', ''),
(60, 1, '440LI016', 100, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '107454.79', '538.39', ''),
(61, 1, '630EO010', 89, '', 'RJ', '', 'ENC', '294011', '010', '1999-06-01', 'D', '65090.16', '465.64', ''),
(62, 1, '270NJ054', 145, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '13249.71', '971.64', ''),
(63, 1, '270BO078', 459, '', 'RJ', '', 'ENC', '295316', '010', '1999-06-01', 'D', '6034.05', '295.35', ''),
(64, 1, '240MZ076', 359, '', 'CTX', '', 'ENC', '295316', '010', '1999-06-01', 'D', '13876.40', '801.95', ''),
(65, 1, '119AO019', 417, '', 'LJ', '', 'ENC', '341043', '008', '2000-04-10', 'D', '31454.96', '593.92', ''),
(66, 1, '100HO079', 6, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '19260.95', '41.97', ''),
(67, 1, '470MZ182', 279, '', 'CTX', '', 'ENC', '295230', '010', '1999-06-01', 'D', '48928.99', '382.05', ''),
(68, 1, '200NJ045', 375, '', 'CTX', '', 'ENC', '299999', '010', '1999-06-01', 'D', '10453.70', '866.32', ''),
(69, 1, '200LI113', 39, '', 'CTX', '', 'ENC', '295230', '010', '1999-06-01', 'D', '35746.72', '41.63', ''),
(70, 1, '180OX022', 69, '', 'CTX', '', 'ENC', '341044', '008', '1999-06-01', 'D', '11144.98', '909.04', ''),
(71, 1, 'J0124502', 230, '', 'LJ', '', 'ENC', '341044', '008', '2001-12-11', 'D', '24716.04', '932.10', ''),
(72, 3, 'J0133964', 441, '', 'LJ', '', 'ENC', '', '000', '2002-01-10', 'D', '138705.37', '528.54', ''),
(73, 1, 'J0088095', 13, '', 'PRE', '', 'ENC', '34102501', '008', '2002-03-11', 'D', '23459.41', '613.43', ''),
...
(76, 1, 'J0092752', 115, '', 'PRE', '', 'ENC', '295230', '010', '2002-03-14', 'D', '11282.85', '171.17', ''),
...
(81, 1, 'I0048539', 298, '', 'LJ', '', 'ENC', '29531501', '010', '2002-08-23', 'D', '61203.65', '518.41', ''),
...
(84, 1, 'H0103641', 328, '', 'CTX', '', 'ENC', '293121', '009', '2001-09-28', 'D', '28551.08', '865.85', ''),
(85, 3, 'H0098156', 73, '', 'CTX', '', 'ENC', '354111', '003', '2003-01-06', 'D', '2494.63', '706.60', ''),
(86, 1, 'K0083879', 382, '', 'CTX', '', 'ENC', '34102501', '002', '0000-00-00', 'S', '27601.93', '612.82', ''),
...
(89, 1, 'KM095399', 406, '', 'CTX', '', 'ENC', '74111421', '000', '2004-11-10', 'D', '74224.82', '208.20', ''),
(90, 1, 'KM063141', 148, '', 'RJ', '', 'ENC', '342023', '008', '2002-08-10', 'D', '2955.93', '832.05', ''),
(91, 1, 'KM063140', 23, '', 'RJ', '', 'ENC', '342023', '008', '2002-10-10', 'D', '1586.27', '955.21', ''),
(92, 1, 'KM063139', 170, '', 'RJ', '', 'ENC', '342023', '008', '2002-03-10', 'D', '5377.84', '665.54', ''),
(93, 1, 'KM015518', 279, '', 'RJ', '', 'ENC', '74111421', '000', '2001-07-20', 'D', '77730.21', '23.42', ''),
(94, 1, 'KM086923', 384, '', 'LJ', '', 'ENC', '45400001', '000', '2001-04-30', 'D', '21580.07', '380.08', ''),
(95, 1, 'KM086922', 83, '', 'LJ', '', 'ENC', '45400001', '000', '2001-03-10', 'D', '3993.40', '995.78', ''),
(96, 1, 'J0091776', 261, '', 'LJ', '', 'ENC', '292421', '010', '2004-08-21', 'D', '2418.07', '529.01', ''),
(97, 1, 'J0076801', 55, '', 'LJ', '', 'ENC', '295111', '010', '2004-03-13', 'D', '3838.07', '49.29', ''),
(98, 1, 'KM071854', 493, '', 'LJ', '', 'ENC', '74111421', '000', '2002-11-26', 'D', '49954.26', '110.41', ''),
(99, 1, 'KM069216', 298, '', 'LJ', '', 'ENC', '74111421', '000', '2002-11-21', 'D', '174557.29', '614.22', ''),
(100, 2, 'KM045120', 12, '', '', '', 'ENC', '74111422', '000', '1998-11-19', 'D', '171570.23', '681.51', ''),
(101, 2, 'KM039545', 166, '', 'RJ', '', 'ENC', '29312301', '009', '2003-01-28', 'D', '15890.03', '410.62', ''),
(102, 2, 'KM005114', 295, '', 'LJ', '', 'ENC', '74111421', '000', '1995-03-13', 'D', '110788.61', '628.22', ''),
...
(105, 2, 'KM090253', 498, '', '', '', 'ENC', '29326201', '009', '2002-11-08', 'D', '6938.22', '449.11', ''),
(106, 2, 'KM095246', 37, '', 'RJ', '', 'ENC', '29326301', '009', '2002-02-21', 'D', '7200.11', '599.20', ''),
(107, 2, 'KM095245', 191, '', 'RJ', '', 'ENC', '29326201', '009', '2001-05-31', 'D', '7548.28', '332.79', ''),
(108, 2, 'KM084222', 344, '', 'RJ', '', 'ENC', '293265', '009', '2001-03-31', 'D', '2545.52', '885.22', ''),
(109, 2, 'KM074138', 146, '', 'LJ', '', 'ENC', '74111421', '000', '2004-12-09', 'D', '2987.34', '844.06', ''),
(110, 2, 'KM072625', 197, '', 'RJ', '', 'ENC', '293265', '009', '2000-12-01', 'D', '7800.86', '65.12', ''),
(111, 2, 'KM071907', 48, '', 'LJ', '', 'ENC', '29312301', '009', '2000-01-20', 'D', '17419.44', '560.85', ''),
(112, 2, 'KM070950', 146, '', 'LJ', '', 'ENC', '74111421', '000', '2002-11-12', 'D', '57762.31', '75.01', ''),
(113, 2, 'KM068727', 89, '', 'CTX', '', 'ENC', '29323301', '009', '2003-01-06', 'D', '17092.10', '312.48', ''),
(114, 2, 'KM054510', 3, '', 'RJ', '', 'ENC', '293262', '009', '1999-10-05', 'D', '17612.30', '242.05', ''),
(115, 2, 'KM054509', 249, '', 'RJ', '', 'ENC', '293262', '009', '1999-10-05', 'D', '29114.16', '746.64', ''),
(116, 2, 'KM054388', 236, '', 'RJ', '', 'ENC', '293265', '009', '1998-12-29', 'D', '2485.51', '22.65', '');
...
CREATE TABLE `prm_cod_ape` (
  `id` int(10) NOT NULL,
  `code` char(3) NOT NULL DEFAULT '',
  `libelle` char(40) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `prm_cod_ape` (`id`, `code`, `libelle`) VALUES
...
INSERT INTO `prm_cod_soc` (`id`, `code`, `libelle`) VALUES
(1, '1', 'SOCIETE 1'),
(2, '2', 'SOCIETE 2'),
(3, '3', 'SOCIETE 3'),
(4, '4', 'SOCIETE 4');
...
INSERT INTO `prm_eta_jur` (`id`, `code`, `libelle`) VALUES
(1, 'CTX', 'Contentieux'),
(2, 'DCD', 'Décédé'),
...
CREATE TABLE `prm_personne` (
  `id` int(10) NOT NULL,
  `code` decimal(8,0) NOT NULL DEFAULT 0,
  `libelle` char(15) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `prm_personne` (`id`, `code`, `libelle`) VALUES
...
INSERT INTO `prm_prd_fin` (`id`, `code`, `libelle`) VALUES
...
INSERT INTO `prm_sta_maj` (`id`, `code`, `libelle`) VALUES
(2, 'ATT', 'En attente'),
(1, 'ENC', 'Encours'),
(3, 'TER', 'Terminé');
...
INSERT INTO `prm_typ_sld` (`id`, `code`, `libelle`) VALUES
(2, 'C', 'Créditeur'),
(1, 'D', 'Débiteur'),
(4, 'I', 'Injustifié'),
(3, 'S', 'Soldé');
...
ALTER TABLE `dossier`
  ADD PRIMARY KEY (`id`),
  ADD KEY `dossier_l01` (`societe_id`,`id`),
  ADD KEY `dossier_l02` (`societe_id`,`dossier_ref`,`id`),
  ADD KEY `dossier_l03` (`societe_id`,`personne_id`,`id`);

--
-- Index pour la table `prm_cod_ape`
--
ALTER TABLE `prm_cod_ape`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prm_cod_ape_l01` (`code`,`id`),
  ADD KEY `prm_cod_ape_l02` (`libelle`,`code`,`id`);

--
-- Index pour la table `prm_cod_soc`
--
ALTER TABLE `prm_cod_soc`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prm_cod_soc_l01` (`code`,`id`),
  ADD KEY `prm_cod_soc_l02` (`libelle`,`code`,`id`);

--
-- Index pour la table `prm_eta_jur`
--
ALTER TABLE `prm_eta_jur`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prm_eta_jur_l01` (`code`,`id`),
  ADD KEY `prm_eta_jur_l02` (`libelle`,`code`,`id`);

--
-- Index pour la table `prm_personne`
--
ALTER TABLE `prm_personne`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prm_personne_l01` (`code`,`id`),
  ADD KEY `prm_personne_l02` (`libelle`,`code`,`id`);

--
-- Index pour la table `prm_prd_fin`
--
ALTER TABLE `prm_prd_fin`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prm_prd_fin_l01` (`code`,`id`),
  ADD KEY `prm_prd_fin_l02` (`libelle`,`code`,`id`);

--
-- Index pour la table `prm_sta_maj`
--
ALTER TABLE `prm_sta_maj`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prm_sta_maj_l01` (`code`,`id`),
  ADD KEY `prm_sta_maj_l02` (`libelle`,`code`,`id`);

--
-- Index pour la table `prm_typ_sld`
--
ALTER TABLE `prm_typ_sld`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prm_typ_sld_l01` (`code`,`id`),
  ADD KEY `prm_typ_sld_l02` (`libelle`,`code`,`id`);
...
--
ALTER TABLE `dossier`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57835;

--
-- AUTO_INCREMENT pour la table `prm_cod_ape`
--
ALTER TABLE `prm_cod_ape`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT pour la table `prm_cod_soc`
--
ALTER TABLE `prm_cod_soc`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `prm_eta_jur`
--
ALTER TABLE `prm_eta_jur`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `prm_personne`
--
ALTER TABLE `prm_personne`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52980;

--
-- AUTO_INCREMENT pour la table `prm_prd_fin`
--
ALTER TABLE `prm_prd_fin`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT pour la table `prm_sta_maj`
--
ALTER TABLE `prm_sta_maj`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `prm_typ_sld`
--
ALTER TABLE `prm_typ_sld`
